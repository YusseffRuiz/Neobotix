...
if("TRUE" STREQUAL "TRUE")
  set(turtlebot3_gazebo_SOURCE_PREFIX /home/yusseff/Neobotix/src/neobotix_simulations/neobotix_gazebo)
  set(turtlebot3_gazebo_DEVEL_PREFIX /home/yusseff/Neobotix/devel)
  ...
  set(turtlebot3_gazebo_INSTALL_PREFIX /home/yusseff/Neobotix/install)
...
if(NOT "/home/yusseff/Neobotix/src/neobotix_simulations/neobotix_gazebo/include " STREQUAL " ")
  set(turtlebot3_gazebo_INCLUDE_DIRS "")
  set(_include_dirs "/home/yusseff/Neobotix/src/neobotix_simulations/neobotix_gazebo/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'turtlebot3_gazebo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yusseff/Neobotix/src/neobotix_simulations/neobotix_gazebo/${idir}'.  ${_report}")
    endif()
