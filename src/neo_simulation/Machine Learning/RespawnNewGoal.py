...
class Respawn():
    ...
    def getPosition(self, position_check=False, delete=False):
        ...
        if self.stage != 4:
            ...
            goal_x_input = input("Give me X coordinate: ")
            goal_y_input = input("Give me Y coordinate: ")

            self.goal_position.pose.position.x = goal_x_input
            self.goal_position.pose.position.y = goal_y_input
